...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  if(ganador == 1){
			...
			HAL_GPIO_WritePin(LEDA0_GPIO_Port, LEDA0_Pin, GPIO_PIN_SET);
			...
			HAL_GPIO_WritePin(LEDB0_GPIO_Port, LEDB0_Pin, GPIO_PIN_SET);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LEDB3_Pin|LEDB2_Pin|LEDA0_Pin|C_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, B_Pin|E_Pin|LEDA3_Pin|D_Pin
                          |G_Pin|F_Pin|A_Pin|LEDA2_Pin
                          |LEDA1_Pin|LEDB1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LEDB3_Pin LEDB2_Pin LEDA0_Pin C_Pin */
  GPIO_InitStruct.Pin = LEDB3_Pin|LEDB2_Pin|LEDA0_Pin|C_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : B_Pin E_Pin LEDA3_Pin D_Pin
                           G_Pin F_Pin A_Pin LEDA2_Pin
                           LEDA1_Pin LEDB1_Pin */
  GPIO_InitStruct.Pin = B_Pin|E_Pin|LEDA3_Pin|D_Pin
                          |G_Pin|F_Pin|A_Pin|LEDA2_Pin
                          |LEDA1_Pin|LEDB1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : LEDB0_Pin */
  GPIO_InitStruct.Pin = LEDB0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LEDB0_GPIO_Port, &GPIO_InitStruct);
